...
**UPDATE 5 Mar, 2026**: Might I refer you to [lestrrat-go/helium](https://github.com/lestrrat-go/helium)? This is a complete _port_ of libxml2 to Go, with heaps more features such as XSLT3, XPath3.1, XSD 1.1, etc.
